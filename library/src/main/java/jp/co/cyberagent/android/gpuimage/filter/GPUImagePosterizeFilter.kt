 ...
 */
class GPUImagePosterizeFilter : GPUImageFilter {
    companion object {
        const val POSTERIZE_FRAGMENT_SHADER: String = "" +
    ...
    constructor(colorLevels: Int) : super(NO_FILTER_VERTEX_SHADER, POSTERIZE_FRAGMENT_SHADER) {
