 ...
 * D = C1 + C2 * C2a * (1 - C1a)
 */
class GPUImageNormalBlendFilter : GPUImageTwoInputFilter {
    companion object {
        const val NORMAL_BLEND_FRAGMENT_SHADER: String = "varying highp vec2 textureCoordinate;\n" +
    ...
    constructor() : super(NORMAL_BLEND_FRAGMENT_SHADER)
