...
class GPUImageColorBalanceFilter : GPUImageFilter {
    companion object {
        const val GPU_IMAGE_COLOR_BALANCE_FRAGMENT_SHADER: String = "" +
    ...
    private var highlights: FloatArray
    private var preserveLuminosity: Boolean

    constructor() : super(NO_FILTER_VERTEX_SHADER, GPU_IMAGE_COLOR_BALANCE_FRAGMENT_SHADER) {
