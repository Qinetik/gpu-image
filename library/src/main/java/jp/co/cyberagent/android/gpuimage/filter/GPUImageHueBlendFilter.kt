...
class GPUImageHueBlendFilter : GPUImageTwoInputFilter {
    companion object {
        const val HUE_BLEND_FRAGMENT_SHADER: String = "varying highp vec2 textureCoordinate;\n" +
    ...
    constructor() : super(HUE_BLEND_FRAGMENT_SHADER)
}
