...
class GPUImageDivideBlendFilter : GPUImageTwoInputFilter {
    companion object {
        const val DIVIDE_BLEND_FRAGMENT_SHADER: String = "varying highp vec2 textureCoordinate;\n" +
    ...
    constructor() : super(DIVIDE_BLEND_FRAGMENT_SHADER)
