...
class GPUImageSaturationBlendFilter : GPUImageTwoInputFilter {
    companion object {
        const val SATURATION_BLEND_FRAGMENT_SHADER: String = "varying highp vec2 textureCoordinate;\n" +
    ...
    constructor() : super(SATURATION_BLEND_FRAGMENT_SHADER)
