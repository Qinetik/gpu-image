...
public class GPUImageNew {
     ...
     */
    public GPUImageNew(final Context context) {
    ...
    private class LoadImageUriTask extends LoadImageTask {
        ...
        public LoadImageUriTask(GPUImageNew gpuImage, Uri uri) {
            super(gpuImage);
            this.uri = uri;
        }
    ...
    private class LoadImageFileTask extends LoadImageTask {
        ...
        public LoadImageFileTask(GPUImageNew gpuImage, File file) {
            super(gpuImage);
            imageFile = file;
        }
    ...
    private abstract class LoadImageTask extends AsyncTask<Void, Void, Bitmap> {
        ...
        private final GPUImageNew gpuImage;
        private int outputWidth;
        private int outputHeight;

        public LoadImageTask(final GPUImageNew gpuImage) {
